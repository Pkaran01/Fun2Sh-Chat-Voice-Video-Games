...
public class ValidationUtils {
    ...
    public boolean isLoginDataValid(EditText emailTextInputLayout,
                                    EditText passwordTextInputLayout, String email, String password) {
    ...
    public boolean isFullNameValid(EditText fullNameTextInputLayout, String oldFullName,
                                   String newFullName) {
